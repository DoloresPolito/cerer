...
const newnews = [
...

  {
    ...
    date: "2026-05-29",
    title:
      "Licitación ALMA SADI: Entre Ríos entre las provincias con mayor interés para proyectos BESS",
    ...
    location: "Entre Ríos",
    instagramUrl:
      "https://www.instagram.com/p/DY72ej7GGSK/?igsh=MW1ncWQzbnY4d3J4eg==",
  },

  {
    ...
    date: "2026-06-3",
    title:
      "Asamblea Anual de CERER: balance de gestión y renovación de autoridades",
...

  {
    ...
    date: "2026-06-5",
    title:
      "Día Mundial del Medio Ambiente: la energía y la sostenibilidad van de la mano",
  ...
  },
  {
    ...
    date: "2026-06-19",
    title:
      "Arroyo Barú incorpora un nuevo parque solar para fortalecer su desarrollo energético",
  ...
  },
  {
    ...
    date: "2026-06-22",
    title:
      "Día Internacional del Sol: la gran fuente de energía limpia que mueve al planeta",
...

  {
    ...
    location: "Entre Ríos",
    instagramUrl:
      "https://www.instagram.com/cerer.camara.energias.er/p/Da8Ne6LkarE/",
  },

  {
    ...
    date: "2026-07-31",
    title:
      "La energía solar continua sumando proyectos para el sector productivo",
    ...
    location: "Entre Ríos",
    instagramUrl:
      "https://www.instagram.com/p/DbdODaaHEUo/?igsh=anI4OWp4cW9veHdy",
  },

  {
    ...
    date: "2026-08-7",
    title:
      "Régimen de Incentivo a las Nuevas Inversiones (RINI): asesoramiento para empresas y proyectos de inversión",
    subtitle:
      "La Cámara de Energías Renovables de Entre Ríos brinda información y asesoramiento sobre el Régimen de Incentivo a las Nuevas Inversiones (RINI), una herramienta provincial destinada a promover la radicación y expansión de inversiones mediante beneficios energéticos, financieros y fiscales.",
    content: [
      "La Provincia de Entre Ríos cuenta con el Régimen de Incentivo a las Nuevas Inversiones (RINI), establecido por la Ley Provincial N.º 11.162, cuyo objetivo es fomentar la radicación de nuevos proyectos y la expansión de inversiones que contribuyan al desarrollo económico de la provincia.",
      "El régimen contempla distintos beneficios para las inversiones alcanzadas, incluyendo incentivos de carácter energético, financiero y fiscal, además de establecer las condiciones y requisitos necesarios para acceder a cada uno de ellos.",
      "En este marco, la Cámara de Energías Renovables de Entre Ríos (CERER) pone a disposición de sus empresas asociadas y de sus clientes un espacio de consulta y asesoramiento para brindar orientación sobre la operatoria del régimen y las oportunidades que ofrece para nuevos proyectos de inversión.",
      "El objetivo de esta iniciativa es acompañar a empresas, emprendedores e inversores en la evaluación de los beneficios disponibles, facilitando el acceso a información técnica y normativa que contribuya a una adecuada planificación de sus proyectos.",
      "Desde CERER promovemos el conocimiento y la difusión de herramientas que favorecen el desarrollo productivo, la incorporación de nuevas inversiones y el crecimiento sostenible de la provincia de Entre Ríos.",
    ],
    image: "rini.png",
    location: "Entre Ríos",
    instagramUrl: "https://www.instagram.com/p/DbwaRgCmI3Z/?img_index=1",
  },
